...
![create access]({{ site.url }}{{ site.baseurl }}/assets/images/2020-04-17-AssignAccessToVariableGroups.png)
...
![Pipeline Execution]({{ site.url }}{{ site.baseurl }}/assets/images/2020-04-17-PipelineExecution.PNG)

We can see that after the pipeline completes the following variable group is automtically created
![Variable Group Created]({{ site.url }}{{ site.baseurl }}/assets/images/2020-04-17-VariableGroupCreated.png)
...
![Variable Group Content]({{ site.url }}{{ site.baseurl }}/assets/images/2020-04-17-VariableGroupContent.png)
